...
resource "google_storage_bucket_object" "raw_taxi_trips_folder" {
  name   = "raw/taxi_trips/"
  bucket = google_storage_bucket.data_bucket.name
  content = " "
}
...
resource "google_storage_bucket_object" "composer_dags_folder" {
  name   = "composer/dags/"
  bucket = google_storage_bucket.data_bucket.name
  content = " "
}
...
# ML Models Folder
resource "google_storage_bucket_object" "ml_models_folder" {
  name   = "ml/models/"
  bucket = google_storage_bucket.data_bucket.name
  content = " "
}
...
# Temp Spark Folder
resource "google_storage_bucket_object" "temp_spark_folder" {
...
resource "google_storage_bucket_object" "terraform_folder" {
  name   = "terraform/"
  bucket = google_storage_bucket.data_bucket.name
  content = " "
}
